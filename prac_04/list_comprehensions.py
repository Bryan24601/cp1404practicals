...
for naming in full_names:
    lowercase_full_names.append(naming.lower())
...
new_numbers = [y for y in numbers if y > 9]
print(new_numbers)
...
def counting():
    return [i for i in full_names if len(i) > 11]
print(counting())
new_names = ",".join(counting())
# print(new_names)
# print(type(new_names))
splitting = new_names.replace(",", " ")
last_names = splitting.split()
print(last_names[1::2])